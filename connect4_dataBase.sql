...
CONSTRAINT FKpartida FOREIGN KEY (Nro_Partida) REFERENCES Partida(Nro_Partida) ON DELETE CASCADE,
CONSTRAINT FKid_ficha FOREIGN KEY (Id) REFERENCES Ficha(Id) ON DELETE CASCADE,
